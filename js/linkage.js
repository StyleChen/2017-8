...
$(".provis").on("click", function() {
	...
	$(this).siblings(".provi").children("p").on("click", function() {
		...
		for (var i = 0; i < ar.length; i++) {
			$(".city").append("<p>"+ ar[i] +"</p>");
		}
		for (var j = 0; j < br.length; j++) {
			$(".area").append("<p>" + br[j] + "<p>")
		};
		console.log($(".area"));
		$('.citys').html(ar[0]);
		$('.areas').html(br[0]);
...
$(document).on('click', '*', function(e) {
	e.stopPropagation();
	if(!(this.className == 'provis' || this.className == 'citys' || this.className == 'areas' || this.className == 'types' )) {
		$('.provi, .city, .area,.type-con').css({
			"display" : "none"
		})
		proviClick = false;
		citysClick = false;
